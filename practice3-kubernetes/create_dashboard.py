...
print("=" * 60)
print("UPTIME MONITOR - ДИАГРАММЫ")
print("=" * 60)
...
# ----- Biểu đồ trái: Pie chart cho website đầu tiên -----
...
# ----- Biểu đồ phải: Cột chỉ MỘT MÀU XANH (tổng số lần kiểm tra) -----
x = range(len(names))
bars = axes[1].bar(x, total_checks, label="Работает", color="#4CAF50", edgecolor="black")

# Chỉ hiển thị phần trăm uptime (%) bên trong cột (màu trắng)
...
axes[1].set_title("Статистика доступности по URL (Uptime %)", fontsize=12, fontweight="bold")
